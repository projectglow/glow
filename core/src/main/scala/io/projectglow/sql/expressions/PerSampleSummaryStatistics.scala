...
case class PerSampleSummaryStatistics(
  ...
  override protected def withNewChildrenInternal(newChildren: IndexedSeq[Expression]): PerSampleSummaryStatistics =
...
case class SampleDpSummaryStatistics(child: Expression) extends Rewrite {
  ...
  override protected def withNewChildrenInternal(newChildren: IndexedSeq[Expression]): SampleDpSummaryStatistics =
...
case class SampleGqSummaryStatistics(child: Expression) extends Rewrite {
  ...
  override protected def withNewChildrenInternal(newChildren: IndexedSeq[Expression]): SampleGqSummaryStatistics =
    copy(child = newChildren.head)
}