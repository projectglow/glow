...
object LikelihoodRatioTest extends LogitTest {
  ...
  override def init(
      ...
      offsetOption: Option[Array[Double]]): LRTFitState = {
    ...
    val nullFit = LogisticRegressionGwas.newtonIterations(
      nullX,
      y,
      offsetVectorOption,
      nullX.copy,
  ...
  override def runTest(
    ...
    fitState
      .newtonState
      .initFromMatrixAndNullFit(fitState.x, phenotypes, offsetOption, fitState.nullFit.args)
