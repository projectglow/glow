...
.. important:: 
   - data must be accessible locally on each Spark worker using one of these approaches,
      ...
      - Databricks' `local file APIs <https://docs.databricks.com/dbfs/index.html#local-file-apis>`_ automatically mounts cloud object storage to the local filesystem
