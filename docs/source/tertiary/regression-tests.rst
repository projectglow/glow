...
.. invisible-code-block: python
   ...
   assert rows_equal(log_reg_df.head(), Row(contigName='20', start=10000053, names=[], beta=-0.04909334516505058, oddsRatio=0.9520922533449219, waldConfidenceInterval=[0.5523036174500618, 1.6412705443874311], pValue=0.8161087511209355))
