...
mvn_version = mvn_version_file.readline()
...
latex_documents = [
    (master_doc, 'glow.tex', 'glow Documentation',
     'Glow Project', 'manual'),
]
...
man_pages = [
    (master_doc, 'glow', 'glow Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'glow', 'glow Documentation',
     author, 'glow', 'One line description of project.',
     'Miscellaneous'),
]
