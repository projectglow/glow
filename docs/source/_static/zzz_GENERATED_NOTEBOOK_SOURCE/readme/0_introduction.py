...
# MAGIC 
# MAGIC using Microsoft Azure or Amazon Web Services (AWS).
# MAGIC 
# MAGIC __coming soon__: Google Cloud Platform (GCP)
# MAGIC 
# MAGIC 
# MAGIC <img src="https://glow.readthedocs.io/en/latest/_images/glow_ref_arch_genomics.png" alt="logo" width="550"/> 
# MAGIC 
# MAGIC Tested with glow v1
